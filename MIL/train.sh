...
python main.py --label_path ${LABEL_PATH} --loss ${LOSS} --task_config ${TASK_CONFIG} --neg_weight ${NEG_WEIGHT} --neg_margin ${NEG_MARGIN} --imbalance_sampler ${IMBALANCE_SAMPLER} --title ${TITLE} --batch_size=${BATCH_SIZE} --wandb