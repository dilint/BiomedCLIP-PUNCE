...
def main(args):
    ...
    one_fold(args,ckc_metric,train_p, train_l, test_p, test_l,val_p,val_l)
...
def one_fold(args, test_p, test_l):
    # --->initiation
    seed_torch(args.seed)
    ...
    # --->load data
    if args.datasets.lower() == 'camelyon16':
        test_set = C16Dataset(test_p,test_l,root=args.dataset_root,persistence=args.persistence,keep_same_psize=args.same_psize)
    ...
    # the split of ngc has been done 
        ...
        test_set = TCGADataset(test_p,test_l,args.tcga_max_patch,args.dataset_root,persistence=args.persistence,keep_same_psize=args.same_psize)
