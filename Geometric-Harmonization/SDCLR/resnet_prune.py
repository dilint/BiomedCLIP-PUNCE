...
__all__ = ['ResNet', 'prune_resnet18', 'prune_resnet34', 'prune_resnet50', 'prune_resnet101',
           'prune_resnet152']
...
def prune_resnet10(pretrained=False, progress=True, **kwargs):
...
def prune_resnet18(pretrained=False, progress=True, **kwargs):
    r"""ResNet-18 model from
    `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
...
def prune_resnet34(pretrained=False, progress=True, **kwargs):
...
def prune_resnet50(pretrained=False, progress=True, **kwargs):
...
def prune_resnet101(pretrained=False, progress=True, **kwargs):
...
def prune_resnet152(pretrained=False, progress=True, **kwargs):
...
# def prune_resnext50_32x4d(pretrained=False, progress=True, **kwargs):
