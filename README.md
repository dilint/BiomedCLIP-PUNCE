...
# MIL整合 
# meanmil
DATASET_PATH=../extract-features/result-final-gc-features/biomed3
...
# maxmil
DATASET_PATH=../extract-features/result-final-gc-features/biomed2
LABEL_PATH=../datatools/tct-gc/labels
OUTPUT_PATH=output-model
PROJECT_NAME=mil-methods
...
OUTPUT_PATH=output-model
PROJECT_NAME=mil-methods
TITLE_NAME='biomed2-mhim(abmil)-tct-trainval'
...
OUTPUT_PATH=output-model
PROJECT_NAME=mil-methods
TITLE_NAME='biomed2-mhim(transmil)-tct-trainval'
...
# train mil
cd ../mil/scripts
bash abmil.sh biomed1 gc 512
bash transil.sh biomed1 gc 512
bash mhim(abmil).sh biomed1 gc 512
bash transmil(abmil).sh biomed1 gc 512
```
